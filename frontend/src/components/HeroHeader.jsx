export default function HeroHeader({ title, subtitle, children }) {
  return (
    <div className="relative bg-gradient-to-br from-[#0A2342] via-[#1a4a7a] to-[#1e5a96] px-5 pb-7 pt-14 overflow-hidden">
      {/* Decorative rings */}
      ...
      <h1 className="text-[26px] font-bold tracking-tight text-white relative z-10">
        {title}
      </h1>
      {subtitle && (
