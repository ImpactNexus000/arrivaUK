const features = [
  {
    label: 'Accommodation',
    desc: 'Find student housing and flatmates',
    color: 'bg-ios-blue',
    icon: (
  ...
  {
    label: 'Student Resource Hub',
    desc: 'Guides, templates, and essential info',
    color: 'bg-ios-indigo',
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    label: 'Job Listings',
    desc: 'Part-time and graduate opportunities',
    color: 'bg-ios-green',
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    label: 'Affiliate & Partner Deals',
    desc: 'Exclusive discounts from our partners',
    color: 'bg-ios-orange',
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
